...
from launch.actions import TimerAction, ExecuteProcess, GroupAction, SetEnvironmentVariable
from launch_ros.actions import Node

def generate_launch_description():
    return LaunchDescription([

        # === Group 1: YDLIDARのみ、ROS_DOMAIN_ID=1 ====================
        GroupAction([
            ...
            # base_link → laser_frame の固定TF（LIDARに合わせて同じドメイン）
            Node(
                package='tf2_ros',
        ...
        # === Group 2: それ以外すべて、ROS_DOMAIN_ID=0 ===============
        GroupAction([
